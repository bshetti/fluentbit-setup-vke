...
NOTE: This has been tested with AWS Elasticseach in a public configuration for ease of use.
      ...
      Two such options include using a proxy when elasticsearch is in a VPC deployment
      or using Cognito to configure user/password for access into AWS elasticsearch in the public config.
